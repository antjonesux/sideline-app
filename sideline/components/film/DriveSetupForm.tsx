    ...
    <div className="space-y-3 p-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <input
              ...
              placeholder="0"
              className="min-h-[44px] w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2.5 text-center font-mono text-lg font-bold text-white focus:border-emerald-500 focus:outline-none"
            />
      ...
      <label className="block text-xs text-slate-400">
        ...
        <input
          ...
          min={1}
          max={50}
          className="mt-1 min-h-11 w-full rounded-lg border border-slate-700 bg-slate-800 px-3 text-white"
      ...
      <div className="flex gap-2">
        <button
          type="button"
          className={`min-h-11 flex-1 rounded-lg border ${values.starting_side === "OWN" ? "border-transparent bg-emerald-600 text-white" : "border-slate-700 text-slate-300"}`}
        ...
        <button
          type="button"
          className={`min-h-11 flex-1 rounded-lg border ${values.starting_side === "OPP" ? "border-transparent bg-emerald-600 text-white" : "border-slate-700 text-slate-300"}`}
      ...
      <div className="flex gap-2 pt-2">
        <button type="button" className="min-h-11 flex-1 rounded-lg border border-slate-700 text-slate-300" onClick={onCancel}>
          Cancel
        </button>
        <button type="button" disabled={busy} className="min-h-11 flex-1 rounded-lg bg-emerald-600 text-white" onClick={() => void submit()}>
          Start Drive
        </button>
      </div>
    </div>
