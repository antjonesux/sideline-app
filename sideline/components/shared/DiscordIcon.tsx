...
/** Discord Clyde mark — filled with `currentColor` to match adjacent lucide icons. */
export function DiscordIcon({ className, "aria-hidden": ariaHidden = true, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
