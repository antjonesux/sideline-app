...
const VALUES = [
  {
    ...
    body: "Build offensive and defensive game plans before the first snap — and review your film after every game. Enter every matchup with a strategy, not a prayer.",
  },
  {
    icon: Layers,
    title: "Stay organized",
    body: "Keep your best plays exactly where you expect them — grouped into Schemes, logged in Film Room, and organized by situation. No more scrolling. No more forgetting.",
  },
  {
    icon: Shield,
      ...
      <div className="grid items-center gap-16 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-5 text-lg leading-relaxed text-slate-400">
            The Sideline is your coaching intelligence companion — build your plan, call with confidence, review
            your film, and study your tendencies across the season.
          </p>
          <div className="mt-8">
        ...
        <div className="space-y-4">
          {VALUES.map((v) => (
            <div
              key={v.title}
              className="flex gap-4 rounded-2xl border border-slate-700/50 bg-slate-900 p-5 transition-all duration-200 hover:-translate-y-1"
            >
